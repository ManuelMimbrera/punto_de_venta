        ...
        <div class="mt-5">
            @if (! $this->enabled)
                <x-jet-confirms-password wire:then="enableTwoFactorAuthentication">
                    <x-jet-button type="button" wire:loading.attr="disabled" class="bg-green-600 hover:bg-green-500">
                        {{ __('Habilitar') }}
                    </x-jet-button>
            ...
            @else
                ...
                <x-jet-confirms-password wire:then="disableTwoFactorAuthentication">
                    <x-jet-danger-button wire:loading.attr="disabled" class="bg-red-600 hover:bg-red-500">
                        {{ __('Desactivar') }}
                    </x-jet-danger-button>
                </x-jet-confirms-password>
            @endif
