<x-jet-action-section>
    ...
    <x-slot name="description">
        {{ __('Sesiones del navegador administre y cierre la sesión de sus sesiones activas en otros navegadores y dispositivos.') }}
    </x-slot>
    ...
    <x-slot name="content">
        ...
        <div class="flex items-center mt-5">
            <x-jet-button wire:click="confirmLogout" wire:loading.attr="disabled" class="bg-blue-800">
        ...
        <x-jet-dialog-modal wire:model="confirmingLogout">
            ...
            <x-slot name="footer">
                ...
                <x-jet-button class="ml-2 bg-blue-800"
