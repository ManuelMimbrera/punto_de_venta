            ...
            <div class="w-full container mx-auto flex flex-wrap items-center justify-between mt-0 py-2">
                ...
                <div class="w-full flex-grow lg:flex lg:items-center lg:w-auto hidden mt-2 lg:mt-0 bg-white lg:bg-transparent text-black p-4 lg:p-0 z-20">
                    ...
                    <ul class="list-reset lg:flex justify-end flex-1 items-center ">
                        ...
                        <li class="mr-3">
                            <a class="inline-block py-2 px-4 text-black font-bold no-underline" href="{{ url('/Nosotros') }}" >Nosotros</a>

                        </li>
                        <li class="mr-3">
                            <a class="inline-block py-2 px-4 text-black font-bold no-underline" href="{{ url('/Nosotros') }}#equipo">Equipo</a>
            ...
            <div class="container max-w-7xl mx-auto m-8">
                ...
                <div class="flex flex-wrap">
                    <div class="w-5/6 sm:w-1/2 p-6">
                        ...
                        <ul>
                            <li>- Ser caracterizada por fomentar e implantar sistemas avanzados en gestión.</li>
                            <li>- Ser reconocida por su mentalidad de servicio al cliente y por la profesionalidad de sus consultores. </li>
                            <li>- Ser una organización rentable y excelente de la que sus empleados, clientes, socios y entorno social se sientan orgullosos. </li>
                        </ul>
                    ...
                    <div class="w-full sm:w-1/2 p-6">
                        ...
                        <p class="text-gray-600 mb-8">
                            Inicialmente la empresa fue pensada como requisito para una de las materias 
                            impartidas en la institución pero tras analizar detenidamente el número 
                            de personas que están interesadas en sacar un sitio para su empresa los 
                            estudiantes decidieron llevar ese proyecto a un escenario más real 
                            enfocándose en brindar software de calidad que va a ser de ayuda en 
                            los procesos que el cliente requiera asegurando así un diseño ajustado
                             a los lineamientos de usabilidad, un correcto funcionamiento de cada elemento mostrado y ofreciendo máxima seguridad para el resguardo de datos sensibles.
                            WAINE es una empresa regida por valores destacándose a lo largo de los 6 
                            años en el mercado por siempre tener en cuenta la opinión del cliente.
                    ...
                    <div class="w-5/6 sm:w-1/2 p-6">
                        ...
                        <p class="text-gray-600 mb-8">
                            Proporcionar servicios de consultoría estratégica y de gestión, contribuyendo a la innovación y desarrollo de las organizaciones, satisfacer sus necesidades y expectativas, así como las del conjunto de personas que trabajan en la organización para lograr rentabilidad y liderazgo en el mercado.
