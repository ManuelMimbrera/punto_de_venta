<div>
  ...
  <div class="pl-52 pt-5">
    ...
    -->
        ...
        @endif
        <!--Botón de agregar-->
        <h1 class="text-3xl font-bold text-gray-500 float-left pr-1 pt-4">
       Listado de productos 
        ...
        <div class="flex-1 p-4 float-left">
          <span class="hidden sm:block">
              ...
              <button class="flex items-center px-2 pr-4 py-2 h-9 font-medium tracking-wide text-white capitalize transition-colors duration-200 transform bg-green-700 rounded-md dark:bg-gray-800 hover:bg-green-500 dark:hover:bg-gray-700 focus:outline-none  dark:focus:bg-gray-700">
                ...
                <a href="{{ route('producto.new') }}">Nuevo</a></span>
          </button>
        ...
        <div class="flex-1 p-4">
          <span class="hidden sm:block">
              ...
              <button class="flex items-center px-2 py-2 h-9 font-medium tracking-wide text-white capitalize transition-colors duration-200 transform bg-blue-500 rounded-md dark:bg-gray-800 hover:bg-blue-600 dark:hover:bg-gray-700 focus:outline-none  dark:focus:bg-gray-700">
                ...
                <a href="{{ route('categorias') }}">Categoría</a></span>
          </button>
        ...
        <div class="flex-1 p-4">
          <div class="relative md:w-1/3">
            <input type="search" wire:model="buscar" class="w-full pl-10 pr-4 py-2 rounded-lg shadow focus:outline-none focus:shadow-outline text-gray-600 font-medium border-gray-300" placeholder="Buscar producto">
                ...
                <table class="min-w-full divide-y divide-gray-200">
                  ...
                  <tbody class="bg-white divide-y divide-gray-200">
                    ...
                    <tr>
                      ...
                      <td class="px-6 py-4 whitespace-nowrap">
                        <div class="text-sm text-gray-900">{{$prod->name}}</div>
                      </td>
                      <td class="px-6 py-4 whitespace-nowrap">
                        <div class="text-sm text-gray-900">{{$prod->descripcion}}</div>
                      </td>
                      <td class="px-6 py-4 whitespace-nowrap">
                        <div class="text-sm text-gray-900">{{$prod->precio}}</div>
                      </td>
                      <td class="px-6 py-4 whitespace-nowrap">
                        @if ($prod->estado=='Activo')
                        <span class="px-2 inline-flex text-xs leading-5 font-semibold rounded-full bg-green-100 text-green-800">
                          <div class="text-sm text-gray-900">{{$prod->estado}}</div>
                        </span>
                        @else
                      ...
                      <td>
                        <div class="btn-group">
                          ...
                          @if ($prod->estado=='Desactivo')
                          <button wire:click="activar({{$prod->id}})" class="inline-flex items-center px-4 py-2 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-green-600 hover:bg-green-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-green-500">
                            Activar
                          </button>
                          @else
                          <a href="{{route('producto.conf',$prod->id)}}">
                          ...
                          <div class="flex items-end justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
                            ...
                            <div class="inline-block align-bottom bg-white rounded-lg text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-lg sm:w-full" role="dialog" aria-modal="true" aria-labelledby="modal-headline">
                              ...
                              <div class="bg-gray-50 px-4 py-3 sm:px-6 sm:flex sm:flex-row-reverse">
                                ...
                                <button type="button" wire:click="cerrar()" class="mt-3 w-full inline-flex justify-center rounded-md border border-gray-300 shadow-sm px-4 py-2 bg-white text-base font-medium text-gray-700 hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 sm:mt-0 sm:ml-3 sm:w-auto sm:text-sm">
                                  Cancelar
                                </button>
                              </div>
                            </div>
                      ...
                      <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                        ...
                        @if ($prod->estado=='Activo')
                        <a>
                          <button class="modal-open flex items-center px-2 py-2 pr-5 font-medium tracking-wide text-white capitalize transition-colors duration-200 transform bg-red-900 rounded-md dark:bg-gray-800 hover:bg-red-700 dark:hover:bg-gray-700 focus:outline-none  dark:focus:bg-gray-700">
                            <svg class="w-5 h-5 mx-1" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="-ml-1 mr-2 h-5 w-5 bi bi-trash" viewBox="0 0 16 16">
    ...
    <div class="modal-container bg-white w-11/12 md:max-w-md mx-auto rounded shadow-lg z-50 overflow-y-auto">
      ...
      <div class="modal-content py-4 text-left px-6">
        ...
        <button class="flex items-center px-2 py-2 pr-5 font-medium tracking-wide text-white capitalize transition-colors duration-200 transform bg-red-900 rounded-md dark:bg-gray-800 hover:bg-red-700 dark:hover:bg-gray-700 focus:outline-none  dark:focus:bg-gray-700">
                                        ...
                                        <span class="mx-1"><a href="{{route('producto.elim',$prod->id)}}">Eliminar</a></span>
                                    </button>
        </div>
